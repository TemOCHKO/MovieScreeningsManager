...
namespace MovieScreeningsManager.DTOModels.Screenings
{
    public class ScreeningEditDTO
    {
        ...
        public ScreeningEditDTO(Guid id, Guid cinemaHallId, string name, DateTime launchTime, int duration, FilmGenre filmGenre, int yearOfRelease)
        {
            Id = id;
